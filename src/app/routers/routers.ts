...
export class Routers {
  ...
  methodsForRouter() {
    ...
    const createurlTreewithAngular = () => {
      ...
      // queryparams
      const queryParamTree = this.router.createUrlTree(['/routers'], {queryParams: {q: 'angular', category: 'framework'}});
      ...
      // current route
      const currentTreeRoute = this.router.createUrlTree(['edit'], {queryParams:{id:2} ,relativeTo: this.activeRoute});
